...
const Discography = () => {
    ...
    return (
        <div>
            ...
            {
                !show ?<div>
                      <h4>Aqui podras encontrar discografía de tu artista favorito</h4>
                ...
                </div> : <div className='contAlbumSuper'>
                    {
                        <div className='contAlbum'>
                            <img className='imgAlbum' src={discography.album?.filter(e => e.idAlbum === albumId)[0].strAlbumThumb} alt="" />
                            <div className='contTextAlbum'>
                                <p className='pAlbum'>{discography.album?.filter(e => e.idAlbum === albumId)[0].strDescriptionES}</p>
                            </div>
                        </div>
                    }
                </div>
